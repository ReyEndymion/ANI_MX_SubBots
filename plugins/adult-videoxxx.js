...
if (!chat.modohorny && m.isGroup) return conn.sendWritingText(m.chat, `*[❗🔞INFO❗] LOS COMANDOS +18 ESTAN DESACTIVADOS EN ESTE GRUPO, SI ES ADMIN Y DESEA ACTIVARLOS USE EL COMANDO ${usedPrefix}enable modohorny*`, m)  
